        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Citizens_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Expenses_Citizens_CitizenId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Incomes_Citizens_CitizenId",
                        column: x => x.CitizenId,
                        principalTable: "Citizens",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Citizens_ApplicationUserId",
                table: "Citizens",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Expenses_CitizenId_Date",
                table: "Expenses",
                columns: new[] { "CitizenId", "Date" });

            migrationBuilder.CreateIndex(
                name: "IX_Incomes_CitizenId_Date",
                table: "Incomes",
                columns: new[] { "CitizenId", "Date" });
        }
